...
SPIRAL_SHMEM_BUFFER_SIZE=${SHMEM_BUFFER_SIZE:=$(( 48 * 2**30 ))}
SPIRAL_SHMEM_HEADER_SIZE=$(( 1 * 2**30 ))
SPIRAL_DEBUG_BACKEND=NO
SPIRAL_STAGE_OPTIMIZER_POOL_SIZE=1
...
echo -e "SPIRAL_STAGE_OPTIMIZER=${SPIRAL_STAGE_OPTIMIZER}(omp=${OMP_NUM_THREADS},pool=${SPIRAL_STAGE_OPTIMIZER_POOL_SIZE})"
